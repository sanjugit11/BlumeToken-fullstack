...
function getEnvAddresses() {
  return {
    ...
    BLXToken: process.env.BLX_TOKEN_ADDRESS || process.env.VITE_BLX_TOKEN_ADDRESS || "",
    stBLXToken: process.env.STBLX_TOKEN_ADDRESS || process.env.VITE_STBLX_TOKEN_ADDRESS || "",
    BlumeStaking: process.env.STAKING_ADDRESS || process.env.VITE_STAKING_ADDRESS || "",
    MockUSDT: process.env.MOCK_USDT_ADDRESS || process.env.VITE_MOCK_USDT_ADDRESS || "",
    MockOracle: process.env.MOCK_ORACLE_ADDRESS || process.env.VITE_MOCK_ORACLE_ADDRESS || "",
    BlumeLP: process.env.LP_ADDRESS || process.env.VITE_LP_ADDRESS || "",
    BlumeVault: process.env.VAULT_ADDRESS || process.env.VITE_VAULT_ADDRESS || ""
  };
}
